const replacements: Record<string, string> = {
  ...
  "서로 다른 상권 유형을 비교할 때는 점수보다 각 지표와 데이터 범위를 함께 확인하세요.": "When comparing different market types, review the indicators and data coverage alongside the score.",
  "서울시 공식 상권 경계를 기준으로 분석합니다.": "Analysis uses Seoul's official commercial-district boundary.",
  "지도 중심점과 선택 반경을 기준으로 실제 점포를 조회합니다.": "Nearby stores are queried from the map center and selected radius.",
  "선택 업종은 현재 상권 분석 지표를 모두 지원합니다.": "The selected category supports the full market-analysis indicator set.",
  "해당 세부 업종은 점포 위치와 반경 경쟁 지표만 제공합니다.": "This subcategory currently provides store locations and radius-based competition indicators only.",
  "선택 범위에서 해당 업종의 분석 근거를 확인할 수 없습니다.": "No analysis evidence is available for this category in the selected area.",
  ...
  "검색 API에 연결할 수 없습니다. 예시 데이터로 대체하지 않습니다.": "The search API could not be reached. No sample data was substituted.",
  "초기화": "Reset",
  ...
  "같은 조건에서 후보 상권을 비교합니다.": "Compare candidate market areas under the same conditions.",
  "유동": "Foot traffic",
  "순증": "Net change",
  "조회 전": "Not loaded",
  ...
  "선택 반경 안에 조회 가능한 점포가 없습니다.": "No queryable stores are available in the selected radius.",
  "전체보기": "View all",
  "목록 접기": "Show less",
  "기본 지도는 계속 탐색할 수 있으며 새 분석은 지원 지역에서 시작합니다.": "You can keep exploring the base map. New analyses start inside a supported area.",
  ...
  "연남·홍대·합정 지원 지역 안에서 분석 위치를 선택해 주세요.": "Choose an analysis location inside the Yeonnam, Hongdae, or Hapjeong coverage area.",
  "지원 범위를 불러오는 중입니다.": "Loading supported coverage.",
  "지원 범위를 불러오지 못했습니다.": "Could not load supported coverage.",
  "실제 지도는 브라우저 환경에서 표시됩니다.": "The live map is displayed in a browser environment.",
  "실제 지도": "Live map",
  "검색": "Search",
  ...
  "API 순위 근거가 없습니다. 정적 fallback 값으로 순위를 만들지 않습니다.": "No API ranking evidence is available. Rankings are not created from static fallback values.",
  "현재 응답에서 확인 가능한 기간 근거가 없습니다.": "No period evidence is available in the current response.",
  "상권 분석 데이터를 불러오지 못했습니다.": "Could not load market-analysis data.",
  "개·폐업 집계 데이터를 불러오지 못했습니다.": "Could not load opening and closure aggregate data.",
  "서울시가 카드 소비 등을 바탕으로 추정한 상권 집계이며 개별 점포 매출은 아닙니다.": "This is a Seoul market aggregate estimated from card spending and other sources, not individual store sales.",
  "길 단위에서 추정한 이동 인구로, 실제 방문객 수와 같다는 뜻은 아닙니다.": "This is movement population estimated at street level; it is not the same as actual visitor count.",
  ...
  "동일 업종이 집중된 특화상권이지만 집적효과와 과포화를 구분할 근거가 충분하지 않아 가점·감점을 보류합니다.": "This category is concentrated, but the evidence is not strong enough to distinguish agglomeration benefits from saturation, so no adjustment is applied.",
  "동일 업종 집적이 peer group보다 뚜렷하게 높지 않습니다.": "Same-category concentration is not notably higher than the peer group.",
  "동일 업종 집적과 함께 점포당 매출 희석 또는 높은 폐업 신호가 나타나는 과포화 후보입니다.": "This is a possible saturation area, with category concentration alongside diluted sales per store or elevated closure signals.",
  "누락 지표는 50점 중립 방향으로 반영했습니다: 수요 증가율, 업종 다양성, 매출 증가율, 동일 cohort 생존율, 대중교통 접근성, 보행 접근성 근거 신뢰도가 낮아 점수보다 원자료와 누락 지표를 먼저 확인해야 합니다.": "Missing indicators are reflected toward a neutral score of 50. Because evidence confidence is low for demand growth, category diversity, sales growth, cohort survival, transit access, and walkability, review the raw data and missing indicators before relying on the score.",
  "서울시 상권분석서비스(점포-상권)_2025년": "Seoul Commercial Area Analysis Service (Stores by Market Area), 2025",
  "서울시 상권분석서비스 추정매출": "Seoul Commercial Area Analysis Service estimated sales",
};

const orderedReplacements = Object.entries(replacements).sort(([left], [right]) => right.length - left.length);
